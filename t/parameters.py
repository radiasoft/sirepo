...
varParam = [
    ['name', 's', 'Youngs Double Slit Experiment', 'simulation name'],
...
#---Electron Beam
    ...
    ['ebm_i', 'f', 0.1, 'electron beam current [A]'],
    ['ebm_e', 'f', 7.0, 'electron beam avarage energy [GeV]'],
    ...
    ['ebm_dr', 'f', -1.22525, 'electron beam longitudinal drift [m] to be performed before a required calculation'],
    ['ebm_ens', 'f', 0.00096, 'electron beam relative energy spread'],
    ['ebm_emx', 'f', 2.79e-09, 'electron beam horizontal emittance [m]'],
    ['ebm_emy', 'f', 8.4e-12, 'electron beam vertical emittance [m]'],
    # Definition of the beam through Twiss:
    ['ebm_betax', 'f', 22.7, 'horizontal beta-function [m]'],
    ['ebm_betay', 'f', 3.1, 'vertical beta-function [m]'],
    ['ebm_alphax', 'f', 0.0, 'horizontal alpha-function [rad]'],
    ['ebm_alphay', 'f', 0.0, 'vertical alpha-function [rad]'],
    ['ebm_etax', 'f', 0.206, 'horizontal dispersion function [m]'],
...
#---both  params
    ...
    ['und_per', 'f', 0.031, 'undulator period [m]'],
