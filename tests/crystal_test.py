...
pytestmark = pytest.mark.skipif(
    _skip(), reason="Unable to reach " + sirepo.crystal.X0H_SERVER
)
...
def test_srw_calc_bragg_angle():
    ...
    for case in (
        (
            (3.135531576941939, 20368, 1),
            (0.06087205076590731, 0.09722123437454372, 5.570366408713557),
        ),
        (
            (3.1355, 20368, 1),
            (0.06087205076590731, 0.09722221656509854, 5.570422684087026),
        ),
    ):
