# -*- coding: utf-8 -*-
"""PyTest for :mod:`sirepo.template.code_variable.py`
...
def test_eval():
    ...
    pkeq(
        "1 1 gamma 2 pow / - sqrt",
        code_var.infix_to_postfix("sqrt(1 - (1/pow(gamma, 2)))"),
    )
...
def test_infix_to_postfix():
    ...
    pkeq(
        "1 1 gamma 2 pow / - sqrt",
        code_var.infix_to_postfix("sqrt(1 - 1 / gamma ** 2)"),
    )
