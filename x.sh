...
export SIREPO_SIM_DATA_LIB_FILE_URI='http://127.0.0.1:8001/job-cmd-lib-file/RthdjNSsQwomuzU3fJociw62wJ2Iuv7i/'
...
export SIREPO_SIM_DATA_SUPERVISOR_SIM_DB_FILE_TOKEN='FtrRjkj9gJd2lQDWlXehpZ7ox25DeV6m'
