...
class MockOAuthClient(object):
    ...
    def create_authorization_url(self, *args, **kwargs):
        ...
        return (
            f"https://github.com/login/oauth/oauthorize?response_type=code&client_id={github.cfg.key}&redirect_uri={github.cfg.callback_uri}&state={self.values.state}",
            self.values.state,
        )
