...
SIREPO.app.controller('SRWBeamlineController', function (appState, panelState, requestSender, srwService, $scope, simulationQueue) {
    ...
    var toolbarItems = [
        ...
        {type:'sample', title:'Sample', imageFile:null, resolution:2.480469, thickness:10, material:'Au', method:'server', refractiveIndex:3.23075074E-05, attenuationLength:4.06544e-6, show: SIREPO.APP_SCHEMA.feature_config.sample_in_toolbar}
    ];
    self.toolbarItems = [];
