...
SIREPO.app.directive('settingsMenu', function(appDataService, appState, fileManager, panelState, requestSender, $compile, $window, $timeout) {
    ...
    return {
              ...
              '<ul class="nav navbar-nav sr-navbar-right">',
                '<li>',
                  ...
                  '<ul class="dropdown-menu">',
                    ...
                    '<li data-ng-if="hasData()"><a href data-ng-click="jupyterNotebook()"><span class="glyphicon glyphicon-cloud-download sr-nav-icon"></span> Export as Jupyter Notebook</a></li>',
        ...
        controller: function($scope) {
            ...
            $scope.jupyterNotebook = function(modelName) {
                panelState.jupyterNotebook($scope.simulationId(), modelName);
            };
            ...
            $scope.hasData = function() {
                return (appState.models.analysisData || {}).file;
            };
