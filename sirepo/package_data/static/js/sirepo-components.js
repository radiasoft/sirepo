              ...
              '<ul class="nav navbar-nav sr-navbar-right">',
                '<li>',
                  ...
                  '<ul class="dropdown-menu">',
                    ...
                    '<li data-ng-if="::hasSimulationSource()"><a href data-ng-click="pythonSource()"><span class="glyphicon glyphicon-cloud-download sr-nav-icon"></span> {{ ::stringsService.formatKey(\'simulationSource\') }}</a></li>',
