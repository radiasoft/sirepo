...
SIREPO.app.directive('beamlineIcon', function() {
    return {
        ...
        templateUrl: '/static/html/beamline-icon.html' + SIREPO.SOURCE_CACHE_KEY,
        /*
        template: [
...
'<g>',
	'<g>',
		'<g>',
			'<g class="st0">',
				'<g>',
					'<polygon class="st1" points="47.3,37.4 47.8,60.8 39,59.8 38.5,36.5 					"/>',
				'</g>',
				'<g>',
					'<polygon class="st2" points="47.3,37.4 52.8,36.4 53.3,59.7 47.8,60.8 					"/>',
				'</g>',
				'<g>',
					'<polygon class="st3" points="38.5,36.5 44.1,35.5 52.8,36.4 47.3,37.4 					"/>',
				'</g>',
			'</g>',
		'</g>',
	'</g>',
	'<g>',
		'<g>',
			'<g class="st0">',
				'<g>',
					'<polygon class="st1" points="47.3,2.9 47.8,26.2 39,25.3 38.5,1.9 					"/>',
				'</g>',
				'<g>',
					'<polygon class="st2" points="47.3,2.9 52.8,1.8 53.3,25.2 47.8,26.2 					"/>',
				'</g>',
				'<g>',
					'<polygon class="st3" points="38.5,1.9 44.1,0.9 52.8,1.8 47.3,2.9 					"/>',
				'</g>',
			'</g>',
		'</g>',
	'</g>',
	'<g>',
		'<path class="st4" d="M81.5,32.8c-1.1,0-2.1-0.9-2.1-2c0-1.1,0.8-2,1.9-2h0.2c1.1,0,2,0.9,2,2C83.5,31.9,82.6,32.8,81.5,32.8z',
	...
	'</g>',
	'<g>',
		'<path class="st4" d="M38.7,16.6c-1.1,0-2.1-0.9-2.1-2s0.8-2,1.9-2h0.2c1.1,0,2,0.9,2,2S39.8,16.6,38.7,16.6z M30.2,16.6',
...
'</g>',              '</g>',
        ...
        controller: function($scope, $element) {
            $scope.itemTypes = {
                lens: {viewBox: '0 0 612 792'},
                crl: {viewBox: '0 0 612 792'}, zonePlate: {viewBox: '0 0 612 792'}, fiber: {viewBox: '0 0 612 792'}, aperture: {viewBox: '0 0 612 792'}, obstacle: {viewBox: '0 0 612 792'}, mask: {viewBox: '0 0 792 612'}, sample: {viewBox: '0 0 612 792'},
                mirror: {viewBox: '0 0 612 792'}, sphericalMirror: {viewBox: '0 0 612 792'}, ellipsoidMirror: {viewBox: '0 0 612 792'}, toroidalMirror: {viewBox: '0 0 612 792'},
                crystal: {viewBox: '0 0 612 792'}, grating: {viewBox: '0 0 612 792'}, watch: {viewBox: '0 0 612 792'}
            };
        },
    };
});
