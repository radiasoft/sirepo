...
def default_command(in_file):
    ...
    return pkjson.dump_pretty(
        PKDict(getattr(JobProcess, '_do_' + msg.jobProcessCmd)(
            msg,
...
class JobProcess(PKDict):
    ...
    @classmethod
    def _do_cancel(cls, msg, template):
    ...
    @classmethod
    def _do_get_simulation_frame(cls, msg, template):
    ...
    @classmethod
    def _do_get_data_file(cls, msg, template):
        try:
    ...
    @classmethod
    def _do_sequential_result(cls, msg, template):
