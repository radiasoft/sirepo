...
def _run_hellweg(cfg_dir):
    with pkio.save_chdir(cfg_dir):
        ...
        beam_solver = solver.BeamSolver(template.HELLWEG_INI_FILE, template.HELLWEG_INPUT_FILE)
        beam_solver.solve()
        beam_solver.save_output(template.HELLWEG_SUMMARY_FILE)
        beam_solver.dump_bin(template.HELLWEG_DUMP_FILE)
