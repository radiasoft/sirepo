...
fluxcorrectionarray = np.loadtxt(str(sirepo.resource.file_path('template', 'srw', 'brilliance', 'gwSrwBrilUndHarmUnivFlux.txt')))
divcorrectionarray = np.loadtxt(str(sirepo.resource.file_path('template', 'srw', 'brilliance', 'gwSrwBrilUndHarmUnivDiv.txt')))
sizecorrectionarray = np.loadtxt(str(sirepo.resource.file_path('template', 'srw', 'brilliance', 'gwSrwBrilUndHarmUnivSize.txt')))
