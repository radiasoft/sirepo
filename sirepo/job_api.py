...
class API(sirepo.quest.API):
    ...
    # TODO(e-carlin): what api does export use? We want people to be able
    # to export their data from the sim list
    @sirepo.quest.Spec(
    ...
    @sirepo.quest.Spec("require_subscription", frame_id="SimFrameId")
