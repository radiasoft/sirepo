...
class SimData(sirepo.sim_data.SimDataBase):
    ...
    def webcon_analysis_data_file(cls, data):
        return cls.lib_file_name_with_model_field(
            "analysisData", "file", data.models.analysisData.file
        )
    ...
    def _compute_job_fields(cls, data, r, compute_model):
        ...
        if "watchpointReport" in r or r in (
    ...
    def _init_default_beamline(cls, data):
        ...
        data.models.elements = [
            PKDict(_id=8, l=0.1, name="drift", type="DRIF"),
            PKDict(_id=10, hkick=0, name="HV_KICKER_1", type="KICKER", vkick=0),
            PKDict(_id=12, hkick=0, name="HV_KICKER_2", type="KICKER", vkick=0),
            PKDict(_id=13, hkick=0, name="HV_KICKER_3", type="KICKER", vkick=0),
            PKDict(_id=14, hkick=0, name="HV_KICKER_4", type="KICKER", vkick=0),
            PKDict(
                _id=24,
                k1=-5,
                l=0.05,
